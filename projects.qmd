...
[**A Planetary Inventory of Life**](https://cordis.europa.eu/project/id/856506)
...
LIFEPLAN aims to establish the current state of biodiversity across the globe and to use the insights for generating accurate predictions of its future state under future scenarios.

#### Tasks

-   Collaborator (upscaling of data analysis tools for high-performance computing)
